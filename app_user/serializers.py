...
class UserCreateSerializer(CustomModelSerializer):
    ...
    nickname = serializers.CharField(max_length=50,validators=[CustomUniqueValidator(queryset=Users.objects.all(), message="用户昵称必须唯一")])
    phone = serializers.CharField(validators=[CustomUniqueValidator(queryset=Users.objects.all(), message="手机号必须唯一")],allow_blank=True)
